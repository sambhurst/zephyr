...
:kconfig:`CONFIG_NUM_SMF_ANCESTORS` should be set to a value greater than
zero, where the value determines the maximum number of ancestor states a
state can have.
...
when :kconfig:`CONFIG_NUM_SMF_ANCESTORS` is set to a value greater than zero.
